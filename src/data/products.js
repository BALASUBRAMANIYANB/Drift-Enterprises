export const products = [
  ...
  },
  {
    ...
    description: "Ultra HD 4K smart TV with HDR, built-in streaming apps, and voice remote.",
    price: 699.99,
    rating: 4.7,
  ...
  },
  {
    ...
    price: 189.0,
    rating: 4.3,
    image: "https://images.pexels.com/photos/8111329/pexels-photo-8111329.jpeg?auto=compress&cs=tinysrgb&w=600",
    category: "Home & Kitchen",
  },
  {
    id: "4",
    title: "Stainless Steel Cookware Set, 12-Piece",
    description: "Premium stainless steel pots and pans set, compatible with all cooktops.",
    price: 149.99,
    rating: 4.6,
    image: "https://images.pexels.com/photos/1161467/pexels-photo-1161467.jpeg?auto=compress&cs=tinysrgb&w=600",
    category: "Home & Kitchen",
  },
  {
    id: "5",
    title: "Hardcover Fiction Bestseller",
    description: "A gripping, bestselling novel in hardcover with exclusive bonus chapter.",
    price: 24.99,
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Daily skincare routine kit including cleanser, serum, and moisturizer.",
    price: 59.99,
    rating: 4.4,
