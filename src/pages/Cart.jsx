    ...
    <div className="page-shell" style={{ maxWidth: "1000px" }}>
      ...
      {items.length === 0 ? (
        <div style={{ marginTop: "2rem", textAlign: "center" }}>
          ...
          <Link to="/products" className="primary-button" style={{ display: "inline-block" }}>
            Continue Shopping
          </Link>
        </div>
      ) : (
        <div className="cart-layout">
              ...
              <div key={i.id} className="cart-item">
                ...
                <div className="cart-item-body" style={{ flex: 1 }}>
                  ...
                  <div className="cart-item-actions">
                    ...
                    <button onClick={() => removeItem(i.id)} style={{ cursor: "pointer", padding: "0.5rem 0.75rem", background: "#e50914", color: "#fff", border: "none", borderRadius: "4px" }}>
                      Remove
                    </button>
                  </div>
                </div>
          ...
          <div className="cart-summary">
            ...
            <div style={{ paddingTop: "1rem", borderTop: "1px solid #e3e6e6" }}>
              ...
              <Link to="/checkout" className="primary-button wide" style={{ display: "block", textAlign: "center", padding: "0.75rem" }}>
                Proceed to Checkout
              </Link>
            </div>
          </div>
